        ...
        <div class="container text-white head pt-2 pb-2">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="uname" value="<?php echo $row['UsernameEmail'];?>" placeholder="Enter Username or email address" name="email">
                    <span class="hidden" id="usererr"></span>
                </div>
                <div class="form-group">
                    <label>Password: <span class="required">*</span></label>
                    <input type="password" class="form-control" id="pwd" value="<?php echo $row['Password'];?>" placeholder="Enter password" name="password" />
                    <span class="hidden" id="pwderr"></span>
                </div>
                <div class="form-group">
                    <label>Confirm Password: <span class="required">*</span></label>
                    <input type="password" class="form-control" id="cpwd" value="<?php echo $row['Password'];?>" placeholder="Retype Your Password" name="password2">
                    <span class="hidden" id="repwderr" ></span>
                </div>
                <div class="form-group">
                    <label>Mobile Number: <span class="required">*</span></label>
                    <input type="number" class="form-control" value="<?php echo $row['MobileNumber'];?>" id="phone" placeholder="Enter Your Mobile Number" name="phone">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <input type="file" class="custom-file-input" id="image" placeholder="Select Image" name="imagefile" value="<?php echo $file1;?>">
